...
if(void 0!==n)return Math.trunc(1e3*n)},me={matchTimeout:6e4,timeout:6e5},ue={timeout:6e5},le=(e,n,t=me)=>{const r=b(n,e,t)
return Array.from(r,e=>e.namedGroups)},pe=(e,n,t=ue)=>w(n,e,t).namedGroups,fe=(e,n,t,r=ue)=>{const o=w(n,e,r)
